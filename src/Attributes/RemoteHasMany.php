...
use RemoteModels\Relations\RemoteHasMany as RemoteHasManyRelation;
use RemoteModels\RemoteModel;

#[Attribute(Attribute::TARGET_CLASS | Attribute::IS_REPEATABLE)]
final class RemoteHasMany extends RelationAttribute
{
    /**
    ...
    public function make(Model $model): RemoteHasManyRelation
    {
        $relation = new RemoteHasManyRelation(
