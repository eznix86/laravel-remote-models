...
Thank you for considering contributing to Laravel Remote Models! Please review the following guidelines before submitting a pull request.
...
- Apply the automated refactorings by running `composer refactor`.
